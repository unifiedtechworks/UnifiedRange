...
- [ ] Throttle old-image cleanup and new-image processing separately, then change routes, accounts, or private source. Confirm no late response affects another passport or repopulates a stale candidate/result.
