...
- Phase 2F.2 implements owner removal and Phase 2F.3 implements derivative-aware Unpublish by detaching delivery before deleting sanitized text/setup. Direct image replacement remains unimplemented.
