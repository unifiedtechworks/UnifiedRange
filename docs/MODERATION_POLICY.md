...
- New public-image reports show **Generation-bound report** with only a shortened technical generation reference to authorized reviewers. Existing rows without a binding show **Legacy/unbound report** and remain reviewable/status-editable.
