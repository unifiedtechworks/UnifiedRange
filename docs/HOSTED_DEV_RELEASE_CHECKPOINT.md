...
3. Complete hosted Phase 2C-2E image processing/delivery tests plus Phase 2F.1-2F.3 removal/unpublish checks, then add replacement generations and visibility/private-source cleanup before considering wider rendering.
