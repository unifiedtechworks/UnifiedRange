    ...
    return (
      <div className="space-y-4">
        <p className="rounded-md border border-ink/10 bg-white p-4 text-sm leading-6 text-ink/70 shadow-soft">
          You are creating sample data. Submit validates the sample without creating an account record; sign in and use a saved Equipment Passport to create a private Maintenance record.
        </p>
        <MaintenanceLogForm
          mode="create"
