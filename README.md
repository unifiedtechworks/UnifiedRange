...
11. Confirm only the signed-in owner sees **Remove public image** and derivative-aware **Unpublish**; direct image replacement remains unavailable.
...
14. Separately test Unpublish while a derivative is prepared. Confirm the image is detached before the sanitized text/setup is unpublished, the private original remains unchanged, and the public detail disappears. Direct image replacement remains deferred.
