...
- Phase 2G.1 public-image moderation/report contract fields with client-nonwritable moderation state and blocked-state enforcement, plus a Phase 2G.2 detail-only signed-in image report form; no image moderation UI/action yet
